...
#define EBM_IS_INPUT_PORT_CR(object) (EBM_IS_PORT_CR(object) &&(EBM_record_first(object) == EBM_FRONTEND_INPUT_PORT))
#define EBM_IS_FILE_PORT_CR(object) (EBM_IS_PORT_CR(object) &&(EBM_record_second(object) == EBM_FRONTEND_FILE_PORT))
#define EBM_IS_STRING_PORT_CR(object) (EBM_IS_PORT_CR(object) &&(EBM_record_second(object) == EBM_FRONTEND_STRING_PORT))
#endif
